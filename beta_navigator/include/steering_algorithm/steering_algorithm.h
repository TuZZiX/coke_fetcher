...
double UPDATE_RATE = 50.0; // choose the desired-state publication update rate
...
double MAX_SPEED = 1.0; // m/sec; adjust this
double MAX_OMEGA = 1.0; //1.0; // rad/sec; adjust this
